...
;
const metadata = {
    title: 'Munau College of Health Sciences and Technology | Student Portal & Admission',
    description: 'Munau College of Health Sciences and Technology - Premier health sciences institution in Dutse. Student portal, admission management, and academic resources.',
    generator: 'v0.app',
    keywords: 'health sciences, nursing, medical technology, college, Dutse, Nigeria, admission',
    icons: {
        icon: [
            {
                url: '/logo.png',
